  ...
  <div class="WhoUsesCaseStudyList">
    <ul class="WhoUsesCaseStudyList-gridContainer">
        ...
        <li class="WhoUsesCaseStudyList-caseStudy">
          ...
          <li class="WhoUsesCaseStudyList-caseStudy">
            <a href="https://bitly.com/blog/why-we-write-everything-in-go/?utm_source=go-dev&amp;utm_medium=referral&amp;utm_campaign=go-dev&amp;utm_content=case-study" target="_blank" rel="noopener"
        ...
        <li class="WhyGo-reason">
          ...
          <div class="WhyGo-reasonFooter">
            <div class="WhyGo-reasonPackages">
              ...
              <ul class="WhyGo-reasonPackagesList">
                  <li class="WhyGo-reasonPackage">
                    <a href="/pkg/net/http/" target="_blank" rel="noopener">
                      net/http
                    </a>
                  </li>
                  <li class="WhyGo-reasonPackage">
                    <a href="/pkg/html/template/" target="_blank" rel="noopener">
                      html/template
                    </a>
                  </li>
                  <li class="WhyGo-reasonPackage">
                  ...
                  <li class="WhyGo-reasonPackage">
                    <a href="/pkg/database/sql/" target="_blank" rel="noopener">
                      database/sql
                    </a>
                  </li>
                  <li class="WhyGo-reasonPackage">
        ...
        <ul class="js-goCarouselEventsSlides GoCarousel-eventsSlides">
              ...
              <div class="GoCarousel-eventBody">
                <div class="GoCarousel-eventText">
                  ...
                  <h4 class="GoCarousel-eventName">
                    <a href="https://www.meetup.com/Graz-Open-Source-Meetup/events/twfzrsydcfbcc">Go Language Usergroup Graz</a>
                  </h4>
                  <div class="GoCarousel-eventDate">
                    <p>Mar 21, 2022 | Graz,  Austria</p>
                  </div>
                  <p class="GoCarousel-viewMore"><a href="https://www.meetup.com/Graz-Open-Source-Meetup/events/twfzrsydcfbcc">Learn more</a></p>
                </div>
              </div>
            </li>
            <li
            ...
            id="event_slide1">
              ...
              <div class="GoCarousel-eventBody">
                <div class="GoCarousel-eventText">
                  <div class="GoCarousel-eventHeader">Upcoming Events</div>
                  <h4 class="GoCarousel-eventName">
                    <a href="https://www.meetup.com/Golang-Dorset/events/mspblsydcfbcc">Golang Dorset Monthly Meetup</a>
                  </h4>
                  <div class="GoCarousel-eventDate">
                    <p>Mar 21, 2022 | Bournemouth,  United Kingdom</p>
                  </div>
                  <p class="GoCarousel-viewMore"><a href="https://www.meetup.com/Golang-Dorset/events/mspblsydcfbcc">Learn more</a></p>
                </div>
              </div>
            </li>
            <li
            ...
            id="event_slide2">
              <div class="GoCarousel-eventThumbnail">
                  <img
                    loading="lazy"
                    src="https://secure.meetupstatic.com/photos/event/7/2/5/2/thumb_462749266.jpeg"
                    alt="Online GoTalks 22.03.2022 group photo">
              </div>
              <div class="GoCarousel-eventBody">
                <div class="GoCarousel-eventText">
                  <div class="GoCarousel-eventHeader">Upcoming Events</div>
                  <h4 class="GoCarousel-eventName">
                    <a href="https://www.meetup.com/Golang-ZG/events/284627012">Online GoTalks 22.03.2022</a>
                  </h4>
                  <div class="GoCarousel-eventDate">
                    <p>Mar 22, 2022 | Zagreb,  Croatia</p>
                  </div>
                  <p class="GoCarousel-viewMore"><a href="https://www.meetup.com/Golang-ZG/events/284627012">Learn more</a></p>
                </div>
              </div>
            </li>
            <li
            ...
            id="event_slide3">
              ...
              <div class="GoCarousel-eventBody">
                <div class="GoCarousel-eventText">
                  <div class="GoCarousel-eventHeader">Upcoming Events</div>
                  <h4 class="GoCarousel-eventName">
                    <a href="https://www.meetup.com/Golang-North-East/events/mzwncsydcfbdc">Go meetup</a>
                  </h4>
                  <div class="GoCarousel-eventDate">
                    <p>Mar 22, 2022 | Newcastle Upon Tyne,  United Kingdom</p>
                  </div>
                  <p class="GoCarousel-viewMore"><a href="https://www.meetup.com/Golang-North-East/events/mzwncsydcfbdc">Learn more</a></p>
                </div>
              </div>
            </li>
            <li
            ...
            id="event_slide4">
              ...
              <div class="GoCarousel-eventBody">
                <div class="GoCarousel-eventText">
                  <div class="GoCarousel-eventHeader">Upcoming Events</div>
                  <h4 class="GoCarousel-eventName">
                    <a href="https://www.meetup.com/StL-Go/events/284618557">DevOps for Go Developers Workshop</a>
                  </h4>
                  <div class="GoCarousel-eventDate">
                    <p>Mar 23, 2022 | Saint Louis, MO USA</p>
                  </div>
                  <p class="GoCarousel-viewMore"><a href="https://www.meetup.com/StL-Go/events/284618557">Learn more</a></p>
                </div>
              </div>
            </li>
            <li
            ...
            id="event_slide5">
              <div class="GoCarousel-eventThumbnail">
                  <img
                    loading="lazy"
                    src="https://secure.meetupstatic.com/photos/event/7/d/3/1/thumb_464912049.jpeg"
                    alt="Workshop: DevOps for Go Developers group photo">
              </div>
              <div class="GoCarousel-eventBody">
                <div class="GoCarousel-eventText">
                  <div class="GoCarousel-eventHeader">Upcoming Events</div>
                  <h4 class="GoCarousel-eventName">
                    <a href="https://www.meetup.com/golanguagenewyork/events/284538349">Workshop: DevOps for Go Developers</a>
                  </h4>
                  <div class="GoCarousel-eventDate">
                    <p>Mar 23, 2022 | New York, NY USA</p>
                  </div>
                  <p class="GoCarousel-viewMore"><a href="https://www.meetup.com/golanguagenewyork/events/284538349">Learn more</a></p>
                </div>
              </div>
            </li>
            <li
            ...
            id="event_slide6">
              <div class="GoCarousel-eventThumbnail">
                  <img
                    loading="lazy"
                    src="https://secure.meetupstatic.com/photos/event/5/a/d/3/thumb_442823251.jpeg"
                    alt="Workshop: DevOps for Go Developers - Batel Zohar group photo">
              </div>
              <div class="GoCarousel-eventBody">
                <div class="GoCarousel-eventText">
                  <div class="GoCarousel-eventHeader">Upcoming Events</div>
                  <h4 class="GoCarousel-eventName">
                    <a href="https://www.meetup.com/golangsf/events/284538795">Workshop: DevOps for Go Developers - Batel Zohar</a>
                  </h4>
                  <div class="GoCarousel-eventDate">
                    <p>Mar 23, 2022 | San Francisco, CA USA</p>
                  </div>
                  <p class="GoCarousel-viewMore"><a href="https://www.meetup.com/golangsf/events/284538795">Learn more</a></p>
                </div>
              </div>
            </li>
            <li
            ...
            id="event_slide7">
              <div class="GoCarousel-eventThumbnail">
                  <img
                    loading="lazy"
                    src="https://secure.meetupstatic.com/photos/event/a/2/5/5/thumb_484241557.jpeg"
                    alt="Production Ready Concurrency group photo">
              </div>
              <div class="GoCarousel-eventBody">
                <div class="GoCarousel-eventText">
                  <div class="GoCarousel-eventHeader">Upcoming Events</div>
                  <h4 class="GoCarousel-eventName">
                    <a href="https://www.meetup.com/Golang-Estonia/events/284305440">Production Ready Concurrency</a>
                  </h4>
                  <div class="GoCarousel-eventDate">
                    <p>Mar 23, 2022 | Tallinn,  Estonia</p>
                  </div>
                  <p class="GoCarousel-viewMore"><a href="https://www.meetup.com/Golang-Estonia/events/284305440">Learn more</a></p>
                </div>
              </div>
            </li>
            <li
            ...
            id="event_slide8">
              ...
              <div class="GoCarousel-eventBody">
                <div class="GoCarousel-eventText">
                  <div class="GoCarousel-eventHeader">Upcoming Events</div>
                  <h4 class="GoCarousel-eventName">
                    <a href="https://www.meetup.com/EUG-Go/events/ntqdrsydcfbfc">Book Club &gt; Get Programming With Go</a>
                  </h4>
                  <div class="GoCarousel-eventDate">
                    <p>Mar 23, 2022 | Eugene, OR USA</p>
                  </div>
                  <p class="GoCarousel-viewMore"><a href="https://www.meetup.com/EUG-Go/events/ntqdrsydcfbfc">Learn more</a></p>
                </div>
              </div>
            </li>
            <li
            ...
            id="event_slide9">
              ...
              <div class="GoCarousel-eventBody">
                <div class="GoCarousel-eventText">
                  <div class="GoCarousel-eventHeader">Upcoming Events</div>
                  <h4 class="GoCarousel-eventName">
                    <a href="https://www.meetup.com/golangsg/events/284603877">Golang Online Meetup - Mar 2022</a>
                  </h4>
                  <div class="GoCarousel-eventDate">
                    <p>Mar 24, 2022 | Singapore,  Singapore</p>
                  </div>
                  <p class="GoCarousel-viewMore"><a href="https://www.meetup.com/golangsg/events/284603877">Learn more</a></p>
                </div>
              </div>
            </li>
            <li
            ...
            id="event_slide10">
              <div class="GoCarousel-eventThumbnail">
                  <img
                    loading="lazy"
                    src="https://secure.meetupstatic.com/photos/event/5/8/2/c/thumb_354622572.jpeg"
                    alt="March meetup group photo">
              </div>
              <div class="GoCarousel-eventBody">
                <div class="GoCarousel-eventText">
                  <div class="GoCarousel-eventHeader">Upcoming Events</div>
                  <h4 class="GoCarousel-eventName">
                    <a href="https://www.meetup.com/Golang-Pune/events/284606124">March meetup</a>
                  </h4>
                  <div class="GoCarousel-eventDate">
                    <p>Mar 25, 2022 | Pune,  India</p>
                  </div>
                  <p class="GoCarousel-viewMore"><a href="https://www.meetup.com/Golang-Pune/events/284606124">Learn more</a></p>
                </div>
              </div>
            </li>
            <li
            ...
            id="event_slide11">
              <div class="GoCarousel-eventThumbnail">
                  <img
                    loading="lazy"
                    src="https://secure.meetupstatic.com/photos/event/a/9/6/9/thumb_477523369.jpeg"
                    alt="Go Israel Meetup at JFrog TLV group photo">
              </div>
              <div class="GoCarousel-eventBody">
                <div class="GoCarousel-eventText">
                  <div class="GoCarousel-eventHeader">Upcoming Events</div>
                  <h4 class="GoCarousel-eventName">
                    <a href="https://www.meetup.com/Go-Israel/events/284585914">Go Israel Meetup at JFrog TLV</a>
                  </h4>
                  <div class="GoCarousel-eventDate">
                    <p>Mar 28, 2022 | Tel Aviv-Yafo,  Israel</p>
                  </div>
                  <p class="GoCarousel-viewMore"><a href="https://www.meetup.com/Go-Israel/events/284585914">Learn more</a></p>
                </div>
              </div>
            </li>
            <li
            ...
            id="event_slide12">
              ...
              <div class="GoCarousel-eventBody">
                <div class="GoCarousel-eventText">
                  <div class="GoCarousel-eventHeader">Upcoming Events</div>
                  <h4 class="GoCarousel-eventName">
                    <a href="https://www.meetup.com/golang-taipei-meetup/events/284348715">Golang Taipei Gathering #63 Webinar</a>
                  </h4>
                  <div class="GoCarousel-eventDate">
                    <p>Mar 29, 2022 | Taipei,  Taiwan</p>
                  </div>
                  <p class="GoCarousel-viewMore"><a href="https://www.meetup.com/golang-taipei-meetup/events/284348715">Learn more</a></p>
                </div>
              </div>
            </li>
            <li
            ...
            id="event_slide13">
              ...
              <div class="GoCarousel-eventBody">
                <div class="GoCarousel-eventText">
                  <div class="GoCarousel-eventHeader">Upcoming Events</div>
                  <h4 class="GoCarousel-eventName">
                    <a href="https://www.meetup.com/bostongo/events/284515650">Virtual March Meetup</a>
                  </h4>
                  <div class="GoCarousel-eventDate">
                    <p>Mar 29, 2022 | Boston, MA USA</p>
                  </div>
                  <p class="GoCarousel-viewMore"><a href="https://www.meetup.com/bostongo/events/284515650">Learn more</a></p>
                </div>
              </div>
            </li>
            <li
            ...
            id="event_slide14">
              ...
              <div class="GoCarousel-eventBody">
                <div class="GoCarousel-eventText">
                  <div class="GoCarousel-eventHeader">Upcoming Events</div>
                  <h4 class="GoCarousel-eventName">
                    <a href="https://www.meetup.com/Seoul-Go-Meetup/events/284044945">🚀 Golang 1.18 Release Party</a>
                  </h4>
                  <div class="GoCarousel-eventDate">
                    <p>Mar 31, 2022 | Seoul,  Korea (South)</p>
                  </div>
                  <p class="GoCarousel-viewMore"><a href="https://www.meetup.com/Seoul-Go-Meetup/events/284044945">Learn more</a></p>
                </div>
              </div>
            </li>
        </ul>
